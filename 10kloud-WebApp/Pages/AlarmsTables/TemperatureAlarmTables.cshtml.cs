...
namespace _10kloud_CRUD.Pages.AlarmsTables
{
    ...
    public class TemperatureAlarmTablesModel : PageModel
    {
        private readonly IServiceAlarms _alarmService;

        public TemperatureAlarmTablesModel(IServiceAlarms alarmService)
        {
        ...
        public void OnGet()
        {
            Allarmi = _alarmService.GetByAlarmingParameter("temperatura");
